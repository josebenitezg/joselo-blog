...
export const metadata: Metadata = {
  ...
  description: 'Engineer and biohacker 🚀',
  openGraph: {
    title: 'Jose Benitez',
    description: 'ML Engineer and biohacker 🚀',
    url: 'https://joselo.ai',
        ...
        <ThemeProvider attribute="class" defaultTheme="dark" enableSystem>
            ...
            <footer className="fixed bottom-0 w-full dark:bg-grey-950 z-1000 py-2 border-t border-solid border-grey-100 dark:border-grey-700">
                <div className="mx-auto max-w-[712px] px-4 md:px-0 flex justify-between">
                    <a href="https://twitter.com/joselobenitezg">
                        <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
...
<path d="M 11 4 C 7.134 4 4 7.134 4 11 L 4 39 C 4 42.866 7.134 46 11 46 L 39 46 C 42.866 46 46 42.866 46 39 L 46 11 C 46 7.134 42.866 4 39 4 L 11 4 z M 13.085938 13 L 21.023438 13 L 26.660156 21.009766 L 33.5 13 L 36 13 L 27.789062 22.613281 L 37.914062 37 L 29.978516 37 L 23.4375 27.707031 L 15.5 37 L 13 37 L 22.308594 26.103516 L 13.085938 13 z M 16.914062 15 L 31.021484 35 L 34.085938 35 L 19.978516 15 L 16.914062 15 z"></path>
                    ...
                    <div className="text-sm font-nwr">2024 - José Benítez</div>
                </div>
            </footer>
